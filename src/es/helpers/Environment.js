    ...
    switch (type) {
      ...
      case 'migrospro': {
        return {
          ...
          apiToggleFavorite: this.isTestingEnv ? 'https://testadmin.migrospro.ch/umbraco/api/MigrosProProductApi/ToggleFavorite' : 'https://admin.migrospro.ch/umbraco/api/MigrosProProductApi/ToggleFavorite',
