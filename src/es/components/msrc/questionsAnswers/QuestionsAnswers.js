...
/**
 * QuestionsAnswers https://react-components.migros.ch/?path=/story/msrc-community-04-widgets--questions-answers
 ...
 *  {boolean} [image-upload-preview=false]
 * }
 */
export default class QuestionsAnswers extends Prototype() {
  connectedCallback () {
    const showPromises = []
  ...
  render () {
    ...
    return this.loadDependency().then(msrc => {
      ...
      msrc.components.community.questionsAnswers(this.msrcContainer, {
        ...
        imageUploadPreview: this.getAttribute('image-upload-preview') || false
      })
