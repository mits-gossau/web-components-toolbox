...
// CHANGE THIS
const GIT_REPO = 'https://github.com/mits-gossau/web-components-toolbox-logistikplattform.git'
const NEW_PROJECT_DIR = ''
const NEW_PROJECT_NAME = 'web-components-toolbox-logistikplattform'
